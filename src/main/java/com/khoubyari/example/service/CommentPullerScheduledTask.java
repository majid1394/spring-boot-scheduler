...
public class CommentPullerScheduledTask {
	...
	/*@Scheduled(cron = "0 0 12 * * ?") // CRON expression for running at 12:00 PM every da*/
	public void pullRandomComment() {
		...
		// Check for the specific result to stop the scheduled job
		/*if (comment.getResult().equals("specific_result")) {
			scheduledJobEnabled = false;
			log.info("Scheduled job stopped due to specific result.");
			return;
		}*/
